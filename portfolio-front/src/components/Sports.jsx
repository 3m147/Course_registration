...
export default function SportSelectionModal({ onClose, onSelect }) {
  ...
  return (
    <div className="fixed inset-0  bg-opacity-40 flex items-center justify-center z-50">
      <div className="bg-white w-[500px] h-[600px] flex flex-col shadow-2xl">
        ...
        <div className="p-4 border-b-2 border-black bg-white">
            <div className="relative flex items-center">
                ...
                <button 
                    onClick={onClose}
                    className="absolute right-3 text-2xl text-gray-400 hover:text-black"
                >
                    &times;
                </button>
            </div>
